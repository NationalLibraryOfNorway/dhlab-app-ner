...
class TestURNExtraction:
    ...
    def test_extract_urns_from_mixed_content(self, urn_text_with_extra_content, sample_urns):
...
class TestLabelMapping:
    ...
    def test_create_ner_label_mapping(self, mock_ner_dataframe):
        ...
        result = create_ner_label_mapping(personer, steder, organisasjoner, produkter, andre)
